async function login() {
    ...
    try {
        const response = await fetch("https://new-one-vnnv.onrender.com/login", {
            method: "POST",
...
async function requestReset(){
  ...
  try {
    const res = await fetch('https://new-one-vnnv.onrender.com/password-reset/request', {
      method: 'POST', 
      headers: {'Content-Type': 'application/json'},
...
async function confirmReset(){
  ...
  try{
    const res = await fetch(`https://new-one-vnnv.onrender.com/password-reset/confirm/${token}`, {
